/*
 * dynajs:strings -- string utility library mirroring Go's `strings` package
 ...
 *     Go's strings package operates on byte strings (see dynajs:search's
 ...
 *     (contrast with dynajs:search's indexOfAll, which is overlapping).
 *
...
/* ================================================================ *
 *  Argument coercion (mirrors dynajs-search.c's dyn_search_coerce)
 * ================================================================ */
 ...
 *  dynajs:search's overlapping indexOfAll).
 * ================================================================ */
...
int js_nat_init_strings(JSContext *ctx)
{
    ...
    m = JS_NewCModule(ctx, "dynajs:strings", dyn_strings_init_module);
    if (!m)
        return -1;
