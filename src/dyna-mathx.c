/*
 * dyna:mathx -- extended math utilities, self-contained, in-repo (no
 ...
 *            Pi, E, MaxSafeInteger } from "dyna:mathx";
 ...
 *     changes -- the same stance src/dyna-time.c documents for calendar
 ...
 *     everywhere else a native module accepts a BigInt (dyna-time.c,
 *     dyna-random.c, dyna-encoding.c): there is no arbitrary-precision
