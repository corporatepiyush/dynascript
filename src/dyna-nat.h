...
int js_nat_init_container(JSContext *ctx); /* dyna:container Heap/List/Ring */
#endif
...
int js_nat_init_text(JSContext *ctx); /* dyna:text SIMD byte/text utilities */
#endif
#ifdef CONFIG_NATIVE_MODULE_PATH
int js_nat_init_path(JSContext *ctx); /* dyna:path POSIX path utilities */
#endif
#ifdef CONFIG_NATIVE_MODULE_NETIP
int js_nat_init_netip(JSContext *ctx); /* dyna:netip IP/CIDR (Go net/netip) */
#endif
...
int js_nat_init_strings(JSContext *ctx); /* dyna:strings Go+JS string utilities */
#endif
...
int js_nat_init_crypto(JSContext *ctx); /* dyna:crypto hashes/HMAC/CRC */
#endif
...
int js_nat_init_mathx(JSContext *ctx); /* dyna:mathx Go-style math + int/BigInt helpers */
#endif
...
int js_nat_init_uuid(JSContext *ctx); /* dyna:uuid RFC 9562 UUID v4/v7/v3/v5 + parse */
#endif
#ifdef CONFIG_NATIVE_MODULE_BITS
int js_nat_init_bits(JSContext *ctx); /* dyna:bits Go math/bits port */
#endif
